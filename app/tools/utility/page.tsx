...
const utilityToolsList = [
  {
    ...
    description: "Instant conversion between mechanical, thermal, electrical, and fabrication units.",
    link: "/tools/utility/unit-converter",
    borderGlow: "hover:border-cyan-500/30 hover:shadow-[0_0_30px_rgba(6,182,212,0.1)]",
  },
  {
    id: "currency-converter",
    title: "Currency Converter",
    description: "Real-time foreign exchange matrix and global currency value evaluator.",
    link: "/tools/utility/currency-converter",
    borderGlow: "hover:border-cyan-500/30 hover:shadow-[0_0_30px_rgba(6,182,212,0.1)]",
  },
  {
    id: "qr-generator",
    title: "QR Code Generator",
    description: "Convert text matrices, raw URLs, and credentials into high-density vector QR codes.",
    link: "/tools/utility/qr-generator",
    borderGlow: "hover:border-cyan-500/30 hover:shadow-[0_0_30px_rgba(6,182,212,0.1)]",
  },
  {
    id: "password-generator",
    title: "Password Generator",
    description: "Generate highly secure cryptographically-strong entropy keys client-side.",
    link: "/tools/utility/password-generator",
    borderGlow: "hover:border-cyan-500/30 hover:shadow-[0_0_30px_rgba(6,182,212,0.1)]",
  },
  {
    id: "word-counter",
    title: "Word Counter",
    description: "Real-time dynamic paragraph analysis, word density, and lexical metric engine.",
    link: "/tools/utility/word-counter",
    borderGlow: "hover:border-cyan-500/30 hover:shadow-[0_0_30px_rgba(6,182,212,0.1)]",
  },
  {
    id: "character-counter",
    title: "Character Counter",
    description: "Precise character limit analytics including space padding and symbol checks.",
    link: "/tools/utility/character-counter",
    borderGlow: "hover:border-cyan-500/30 hover:shadow-[0_0_30px_rgba(6,182,212,0.1)]",
  },
  {
    id: "text-case-converter",
    title: "Text Case Converter",
    description: "Instantly transform text strings into UPPERCASE, lowercase, camelCase, or Title Case.",
    link: "/tools/utility/text-case-converter",
    borderGlow: "hover:border-cyan-500/30 hover:shadow-[0_0_30px_rgba(6,182,212,0.1)]",
  },
];
...
export default function UtilityHubPage() {
  ...
  const filteredTools = utilityToolsList.filter((tool) =>
    ...
    <main className="min-h-screen bg-zinc-950 text-white pt-28 pb-20 px-4 select-none">
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        <div className="w-full max-w-4xl mx-auto h-[90px] bg-zinc-900/20 border border-dashed border-zinc-900 rounded-xl flex items-center justify-center text-xs font-mono text-zinc-700 tracking-widest">
          [ DARKSYON_UTILITY_HUB_TOP_AD_728X90 ]
        </div>
        ...
        <section className="text-center space-y-4 border-b border-zinc-900 pb-10">
          ...
          <p className="text-xs font-mono text-zinc-400 max-w-xl mx-auto leading-relaxed">
            Access everyday data utilities, textual standard transformations, and rapid client-side operational widgets.
          </p>
          ...
          <div className="max-w-xl mx-auto relative group pt-4">
            ...
            <input
              ...
              className="w-full h-11 rounded-xl bg-zinc-900/30 border border-zinc-900 pl-11 pr-4 text-sm font-mono placeholder:text-zinc-700 focus:border-cyan-500/30 transition-all backdrop-blur-md outline-none"
            />
          </div>
        </section>
        ...
        <section className="space-y-6">
          <h2 className="text-xs font-mono font-bold uppercase tracking-widest text-zinc-600">
            Active Essential Modules ({filteredTools.length})
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              >
                <div className="flex items-start justify-between gap-4">
                  <div className="flex items-center gap-3">
                    <Zap className="w-5 h-5 text-zinc-500 group-hover:text-cyan-400 transition-colors" />
                    <h3 className="text-md font-bold text-zinc-200 group-hover:text-white transition-colors">{tool.title}</h3>
                  </div>
                  <ChevronRight className="w-4 h-4 text-zinc-700 group-hover:text-cyan-400 transition-all" />
                </div>
                
                <p className="text-xs text-zinc-400 leading-relaxed min-h-[36px]">{tool.description}</p>
                
                <div className="border-t border-zinc-900/60 pt-3 text-[10px] font-mono uppercase text-zinc-600 group-hover:text-cyan-400 tracking-wider flex items-center gap-1">
                  Launch Widget <ArrowRight className="w-3 h-3" />
                </div>
              </Link>
            ))}
            ...
            {filteredTools.length > 0 && (
              <div className="border border-zinc-900/40 bg-zinc-900/5 rounded-2xl p-6 flex flex-col items-center justify-center text-center border-dashed text-[11px] font-mono text-zinc-700 min-h-[160px]">
                <span>[ SPONSORED UTILITY LINK ]</span>
              </div>
            )}
          </div>
        </section>
        ...
        <div className="w-full max-w-4xl mx-auto h-[90px] bg-zinc-900/20 border border-dashed border-zinc-900 rounded-xl flex items-center justify-center text-xs font-mono text-zinc-700 tracking-widest mt-12">
          [ DARKSYON_UTILITY_HUB_BOTTOM_AD_728X90 ]
        </div>
