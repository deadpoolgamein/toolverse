...
import { Hammer, Search, ChevronRight, ArrowRight } from "lucide-react";
import Link from "next/link";

const woodworkingToolsList = [
  {
    id: "cft-calculator",
    title: "Wood Cubic Feet (CFT) Calculator",
    description: "Calculate exact Cubic Feet (CFT) volume and total financial cost for both Round Logs and Square Lumber.",
    link: "/tools/woodworking/cft-calculator",
    borderGlow: "hover:border-emerald-500/30 hover:shadow-[0_0_30px_rgba(16,185,129,0.1)]",
    icon: Hammer
  }
];
...
export default function WoodworkingHubPage() {
  ...
  const filteredTools = woodworkingToolsList.filter((tool) =>
      ...
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        <section className="text-center space-y-4 border-b border-zinc-900 pb-10">
          <div className="flex items-center justify-center gap-3">
            ...
            <h1 className="text-3xl font-black tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-white via-zinc-200 to-zinc-500">
              Carpentry & Woodworking Suite
            </h1>
          </div>
          <p className="text-xs font-mono text-zinc-400 max-w-xl mx-auto leading-relaxed">
            Precision engineering modules for raw timber estimation, volume analytics, and panel layout management.
          </p>
          ...
          <div className="max-w-xl mx-auto relative group pt-4">
            ...
            <input
              ...
              placeholder="Search woodworking tools..."
              className="w-full h-11 rounded-xl bg-zinc-900/30 border border-zinc-900 pl-11 pr-4 text-sm font-mono placeholder:text-zinc-700 focus:border-emerald-500/30 transition-all backdrop-blur-md outline-none"
            />
          </div>
        </section>
        ...
        <section className="space-y-6">
          <h2 className="text-xs font-mono font-bold uppercase tracking-widest text-zinc-600">
            Active Carpentry Modules ({filteredTools.length})
          </h2>
              ...
              >
                <div className="flex items-start justify-between gap-4">
                  <div className="flex items-center gap-3">
                    <tool.icon className="w-5 h-5 text-zinc-500 group-hover:text-emerald-400 transition-colors" />
                ...
                <div className="border-t border-zinc-900/60 pt-3 text-[10px] font-mono uppercase text-zinc-600 group-hover:text-emerald-400 tracking-wider flex items-center gap-1">
