...
import { HardHat, Search, ChevronRight, ArrowRight } from "lucide-react";
import Link from "next/link";

const constructionToolsList = [
  {
    id: "brick-calculator",
    title: "Brick, Cement & Sand Estimator",
    description: "Input wall dimensions to compute total brick count, cement bags, and sand volume required for masonry.",
    link: "/tools/construction/brick-calculator",
...
export default function ConstructionHubPage() {
  ...
  const filteredTools = constructionToolsList.filter((tool) =>
      ...
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        <section className="text-center space-y-4 border-b border-zinc-900 pb-10">
          ...
          <p className="text-xs font-mono text-zinc-400 max-w-xl mx-auto leading-relaxed">
            Architectural estimation engines for volumetric concrete tracking, brick wall layouts, and material overheads.
          </p>
        ...
        <section className="space-y-6">
          <h2 className="text-xs font-mono font-bold uppercase tracking-widest text-zinc-600">
            Active Construction Engines ({filteredTools.length})
          </h2>
              ...
              >
                <div className="flex items-start justify-between gap-4">
                  <div className="flex items-center gap-3">
                    <tool.icon className="w-5 h-5 text-zinc-500 group-hover:text-blue-400 transition-colors" />
