...
import { Sliders, HelpCircle, Activity, ShieldAlert, Sparkles } from "lucide-react";
      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-3 bg-zinc-900/10 border border-zinc-900 rounded-2xl p-6 flex flex-col justify-between relative overflow-hidden min-h-[400px]">
            ...
            {/* 📚 ADSENSE COMPLIANCE: PIPE NOTCH INSIGHTS */}
<section className="mt-12 border-t border-zinc-900 pt-10 space-y-6 max-w-4xl mx-auto">
  <div className="space-y-2">
    <h2 className="text-lg font-black tracking-tight text-zinc-100 flex items-center gap-2">
      <Sparkles className="w-4 h-4 text-sky-400" /> Structural Tube Fishmouth Profile Generators
    </h2>
    <p className="text-xs font-mono text-zinc-400 leading-relaxed">
      This structural engine processes pipe notch cutting profiles for fishmouth joint designs. Tracking intersect paths and pipe sizes locally, it outputs flat layout templates that simplify tubing assembly welds.
    </p>
  </div>
  <div className="pt-4 border-t border-dashed border-zinc-900/60 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
    <div className="text-left space-y-0.5">
      ...
      <p className="text-[10px] text-zinc-600 font-mono">Master intersection mapping methods to join circular pipe outlines flush.</p>
    </div>
    <a href="/blog/pipe-fishmouth-notch-guide" className="w-full md:w-auto h-11 px-6 flex-shrink-0 rounded-xl bg-gradient-to-r from-sky-500/10 to-indigo-500/10 border border-sky-500/20 hover:border-sky-500/40 text-sky-400 font-mono font-bold text-xs flex items-center justify-center gap-2 transition-all whitespace-nowrap">
